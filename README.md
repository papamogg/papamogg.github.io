...
We believe your business is your business, which is why we've designed this App to operate with zero data collection.
...
# 4. Security
Since your data is stored locally, its security depends on the security of your physical device. We recommend using your device's built-in security features (such as Passcode, FaceID, or TouchID) to prevent unauthorized access to your information.

# 5. Changes to This Policy
We may update this policy from time to time. However, our core philosophy remains: your data stays on your device. If we ever change the way the app handles data (e.g., adding cloud sync), we will notify you through a prominent update notice.
